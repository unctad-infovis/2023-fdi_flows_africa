  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/2023-fdi_flows_africa - data.csv', to: '../public/assets/data/2023-fdi_flows_africa_data.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},

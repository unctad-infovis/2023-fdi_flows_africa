      ...
      chart: {
        events: {
          load() {
            ...
            this.renderer.image(`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-fdi_flows_africa/' : './'}assets/img/unctad_logo.svg`, 20, 15, 80, 100).add();
          }
        },
        height: '125%',
        resetZoomButton: {
